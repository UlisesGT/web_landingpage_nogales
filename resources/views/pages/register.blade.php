...
@section('title', 'Create Account - El Sabor de Jalisco')
@section('description', 'Create your El Sabor de Jalisco account to enjoy exclusive benefits and faster ordering.')
...
<section class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="space-y-6" id="register-form">
            <!-- Full Name Field -->
            <div>
                <label for="fullname" class="block text-sm font-medium text-dark-gray-700 mb-2">
                    Full Name
                </label>
                <input 
                    type="text" 
            ...
            <!-- Phone Field -->
            <div>
                <label for="phone" class="block text-sm font-medium text-dark-gray-700 mb-2">
                    Phone Number
                </label>
                <input 
                    type="tel" 
            ...
            <div>
                <label for="confirm-password" class="block text-sm font-medium text-dark-gray-700 mb-2">
                    Confirm Password
                </label>
                <input 
                    type="password" 
            ...
            <div class="flex items-start">
                ...
                <label for="terms" class="ml-3 text-sm text-dark-gray-600">
                    I agree to the 
                    <a href="#" class="text-orange-500 hover:text-orange-600 font-medium">Terms of Service</a>
                    and 
        ...
        <div class="mt-8">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-4 bg-gray-50 text-dark-gray-600">Or sign up with</span>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    registerForm.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            alert('Account created successfully! Welcome to El Sabor de Jalisco!');
